...
pcd.plot(
    screenshot=r"D:\BGIpy37_pytorch113\three_d_analysis_image\mesh_img\cns_pcd_new.png",
    background="white",
)
...
mesh.plot(
    screenshot=r"D:\BGIpy37_pytorch113\three_d_analysis_image\mesh_img\cns_surf_new.png",
    background="white",
)
...
sd.tl.mesh_to_vtk(
    mesh=pcd,
    filename=r"D:\BGIpy37_pytorch113\three_d_analysis_image\mesh_vtk\cns_pcd_new.vtk",
)
sd.tl.mesh_to_vtk(
    mesh=mesh,
    filename=r"D:\BGIpy37_pytorch113\three_d_analysis_image\mesh_vtk\cns_surf_new.vtk",
)
