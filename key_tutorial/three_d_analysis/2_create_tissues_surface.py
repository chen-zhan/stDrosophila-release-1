...
sd.tl.mesh_to_vtk(
    mesh=fb_pcd,
    filename=r"D:\BGIpy37_pytorch113\three_d_analysis_image\mesh_vtk\fb_pcd.vtk",
)
sd.tl.mesh_to_vtk(
    mesh=fb_surf,
    filename=r"D:\BGIpy37_pytorch113\three_d_analysis_image\mesh_vtk\fb_surf.vtk",
)
...
sd.tl.mesh_to_vtk(
    mesh=cns_pcd,
    filename=r"D:\BGIpy37_pytorch113\three_d_analysis_image\mesh_vtk\cns_pcd.vtk",
)
sd.tl.mesh_to_vtk(
    mesh=cns_surf,
    filename=r"D:\BGIpy37_pytorch113\three_d_analysis_image\mesh_vtk\cns_surf.vtk",
)
