...
cns_pcd = pv.read(r"D:\BGIpy37_pytorch113\three_d_analysis_image\mesh_vtk\cns_pcd_new.vtk")
cns_surf = pv.read(r"D:\BGIpy37_pytorch113\three_d_analysis_image\mesh_vtk\cns_surf_new.vtk")
body_surf = pv.read(r"D:\BGIpy37_pytorch113\three_d_analysis_image\mesh_vtk\basic_surf.vtk")
print(fb_pcd.points)
pcd = sd.tl.merge_mesh([fb_pcd, cns_pcd])
surf = sd.tl.merge_mesh([fb_surf, cns_surf, body_surf])

sd.pl.three_d_plot(
    mesh=pcd, key="groups", off_screen=False, window_size=(1024, 768), background="white", background_r="black",
...
sd.pl.three_d_plot(
    mesh=surf, key="groups", off_screen=False, window_size=(1024, 768), background="white", background_r="black",
    ambient=0.3, opacity=1.0, initial_cpo="iso", legend_loc="lower right", legend_size=(0.1, 0.1),
...
sd.tl.mesh_to_vtk(mesh=surf, filename=r"D:\BGIpy37_pytorch113\three_d_analysis_image\mesh_vtk\merge_surf.vtk")
