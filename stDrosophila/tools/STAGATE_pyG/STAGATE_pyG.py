...
class STAGATE(torch.nn.Module):
    def __init__(self, in_channels):
        ...
        self.conv1 = GATConv(in_channels, 512, heads=1, concat=False,
                             dropout=0, add_self_loops=False, bias=False)
        self.conv2 = GATConv(512, 30, heads=1, concat=False,
                             dropout=0, add_self_loops=False, bias=False)
        self.conv3 = GATConv(30, 512, heads=1, concat=False,
                             dropout=0, add_self_loops=False, bias=False)
        self.conv4 = GATConv(512, in_channels, heads=1, concat=False,
                             dropout=0, add_self_loops=False, bias=False)
    ...
    def forward(self, x, edge_index):
        ...
        x3 = F.elu(self.conv3(x2, edge_index, attention=True,
