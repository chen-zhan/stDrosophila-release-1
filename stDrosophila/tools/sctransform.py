...
def sct_dynamo(adata, min_cells=5, gmean_eps=1, n_genes=2000, n_cells=None, bin_size=20, bw_adjust=3, inplace=False):
    ...
    return sctransform(adata, min_cells=min_cells, gmean_eps=gmean_eps, n_genes=n_genes, n_cells=n_cells,
                       bin_size=bin_size, bw_adjust=bw_adjust, inplace=inplace)
